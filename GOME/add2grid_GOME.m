function OMI = add2grid_GOME(Data,reslat,reslon,lonbdy,latbdy)
...
OMI = hdf_quadrangle_GOME(Data, maxx, minx, maxy, miny, lCoordLon, lCoordLat, Lon1, Lon2, Lon4, Lat1, Lat2, Lat4);
