function OMI = add2grid_DOMINO(Data,OMI,reslat,reslon,lonbdy,latbdy)

% add2grid_DOMINO Updated version of add2grid_5km_2014 intended to be a
% usable for gridding DOMINO.
%
